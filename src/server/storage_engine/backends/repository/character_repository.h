#ifndef MIR2_STORAGE_ENGINE_BACKENDS_REPOSITORY_CHARACTER_REPOSITORY_H_
#define MIR2_STORAGE_ENGINE_BACKENDS_REPOSITORY_CHARACTER_REPOSITORY_H_
...
#endif  // MIR2_STORAGE_ENGINE_BACKENDS_REPOSITORY_CHARACTER_REPOSITORY_H_
