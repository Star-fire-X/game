...
#ifndef MIR2_STORAGE_ENGINE_BACKENDS_REDIS_REDIS_MANAGER_H_
#define MIR2_STORAGE_ENGINE_BACKENDS_REDIS_REDIS_MANAGER_H_
...
#endif  // MIR2_STORAGE_ENGINE_BACKENDS_REDIS_REDIS_MANAGER_H_
