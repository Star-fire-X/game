...
#ifndef MIR2_STORAGE_ENGINE_BACKENDS_POSTGRES_PG_CONNECTION_POOL_H_
#define MIR2_STORAGE_ENGINE_BACKENDS_POSTGRES_PG_CONNECTION_POOL_H_
...
#endif  // MIR2_STORAGE_ENGINE_BACKENDS_POSTGRES_PG_CONNECTION_POOL_H_
