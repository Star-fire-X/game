...
#ifndef MIR2_SERVER_LOGIC_HANDLERS_MOVEMENT_MOVEMENT_VALIDATOR_H_
#define MIR2_SERVER_LOGIC_HANDLERS_MOVEMENT_MOVEMENT_VALIDATOR_H_
...
#endif  // MIR2_SERVER_LOGIC_HANDLERS_MOVEMENT_MOVEMENT_VALIDATOR_H_
