#ifndef MIR2_STORAGE_ENGINE_BACKENDS_STORAGE_ENGINE_BACKEND_H_
#define MIR2_STORAGE_ENGINE_BACKENDS_STORAGE_ENGINE_BACKEND_H_
...
#endif  // MIR2_STORAGE_ENGINE_BACKENDS_STORAGE_ENGINE_BACKEND_H_
